    ...
    >
      <div className="max-w-6xl mx-auto p-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm">
          <Link to="/jobs" className="text-muted hover:text-primary">
            Jobs
          </Link>
          <Link to="/post-job" className="text-muted hover:text-primary">
            Post Job
          </Link>
          <Link to="/messages" className="text-muted hover:text-primary">
            Messages
          </Link>
          {user ? (
            <>
              <Link to="/profile/me" className="text-muted">
              ...
              <button
                ...
                className="ml-3 inline-flex items-center px-3 py-1 rounded bg-red-600 text-white text-sm hover:bg-red-500"
              >
                Logout
              </button>
            </>
            ...
            <Link
              to="/login"
              className="inline-flex items-center px-3 py-1 rounded bg-primary text-white text-sm hover:opacity-90"
            >
              Sign in
            </Link>
          )}
