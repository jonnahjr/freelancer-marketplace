...
const jobs = [
  { id: '1', title: 'Build a marketing website', description: 'React + Tailwind, 3 page site, responsive' },
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">
              Browse curated job posts, hire trusted freelancers, and manage contracts and payments — all in one
              beautiful place.
            </p>
            <div className="flex gap-4">
              ...
              <a className="inline-flex items-center px-6 py-3 border rounded-lg hover:shadow transition" href="/post-job">
                Post a Job
              </a>
            </div>
          </motion.div>
